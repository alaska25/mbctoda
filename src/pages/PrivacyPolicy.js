...
export default function PrivacyPolicy() {
	return(
		...
		<Container>
			...
			<li>Driver Application Information. If you decide to join our MBCTodas driver community, in addition to the basic registration information we ask you for your date of birth, physical address, national identity number, driver’s license information, vehicle information, and etc. We share this information with our partners who help us by running background checks on Drivers to help protect the MBCTodas community.</li>

			<h3>How We Use the Information We Collect</h3>
			<p>We use the information we collect from all Users to:</p>
			<li>Provide, improve, expand, and promote the MBCTodas Platform.</li>
