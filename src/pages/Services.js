	...
	return(
		...
		<div className="container h-100 p-3" id="services">
			...
			<div className="d-flex align-items-center justify-content-center">
			         ...
			         <h3>Book A Ride</h3>
			         <p>MBCTodas app is a ride hailing that connects commuters to available drivers via calls and messages.</p>
			         </Button>
			         <Button as={Link} to="/MemberList" eventKey="/MemberList" className="m-2 w-100 h-30">
			         <h3>Buy/Delivery Service</h3>
			         <p> Do you need to buy something? MBCTodas driver will be your personal shoppers to a public market and malls.</p>
			         </Button>
			 </div>
		</div>
		</>
